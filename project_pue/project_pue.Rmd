...
photo: resources/img/Gilbert_01_07_19.jpeg
...
# Introduction
My name is *Gilbert Permalloo*. I am a Research Project Officer and I am presently working on roots architecture and rhizosphere of wheat. My background is mainly sugarcane agronomy and I have been doing a little bit of programming in Fortran 77 and GWBasic about 30 years ago. Most of my data manipulation and visualisation were done in Excel. I could not write any code in R before I joined Data School and I was spending lots of time working with data in spreadsheets. On the otherhand, I am amazed to witness every day the marvel that R can do when working with data.

# My Project
The aim of this project is Rather than yourself, this is the space to introduce your **project**. What are 
...
![](resources/img/pXRF.jpg){width=100px}
